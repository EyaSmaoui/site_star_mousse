...
/* ─────────────────────────────────────────
   DATA — Matelas Relax Plus (Officiel)
───────────────────────────────────────── */
const PRODUCT = {
  ...
  // Plage de prix : 510 DT à 1850 DT
  sizes: [
  ...
  features: [
    ...
    "Garantie 10 ans (Premium)",
    "Design ergonomique pour le bien-être maximal",
  ],
};

const RelaxPlus = () => {
  const [selectedSize, setSelectedSize] = useState(PRODUCT.sizes[1]); // 120*190 par défaut
        ...
        <div className="ssn-container">
          <div className="ssn-grid">
            ...
            <div className="ssn-fade">
              <img src={PRODUCT.images[activeImg]} className="ssn-gallery-main" alt="Matelas Relax Plus" />
            ...
            <div className="ssn-fade" style={{ transitionDelay: "0.1s" }}>
              ...
              <p style={{ color: '#64748b' }}>Catégorie : Matelas ergonomique</p>
          ...
          <div className="ssn-tabs ssn-fade">
            ...
            <div style={{ padding: '30px 0', lineHeight: '1.8' }}>
              {activeTab === 'desc' ? (
                <div>
                  <p>Le <strong>Matelas Relax Plus</strong> est un véritable havre de détente avec sa technologie de ressorts ensachés. Chaque ressort fonctionne indépendamment pour vous offrir un soutien personnalisé.</p>
                ...
                <p>Matelas haute gamme avec ressorts ensachés : isolation de mouvement totale. Conçu pour supporter jusqu'à 130kg. Garantie d'usine de 10 ans incluse.</p>
              )}
            </div>
          </div>
        </div>
